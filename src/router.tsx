...
import { VersionSelectorAndCreatorCompView } from './components/menuViews/versionSelectorAndCreator/versionSelectorAndCreatorViewComp';
...
export const routes =
    <Layout>
        ...
        <Route exact path='/selectVersion' component={VersionSelectorAndCreatorCompView} />
